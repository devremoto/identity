...
namespace Skoruba.IdentityServer4.Admin.Helpers
{
    public static class DbMigrationHelpers
    {
            ...
            where TRole : IdentityRole, new()
        {
            ...
            if (!await roleManager.RoleExistsAsync(AuthorizationConsts.TgAppModelAdmin))
            {
                var role = new TRole { Name = AuthorizationConsts.TgAppModelAdmin };
            ...
            if (result.Succeeded)
            {
                ...
                await userManager.AddToRoleAsync(user, AuthorizationConsts.TgAppModelAdmin);
            }
        }
